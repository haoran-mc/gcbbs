...
CREATE TABLE `nodes` (
  ...
  `desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '节点描述',
...
INSERT INTO nodes(`id`, `name`, `alias`, `desc`, `count`, `pid`, `state`, `deleted_at`, `created_at`, `updated_at`)
    VALUES (1, '分享', 'share', '技术分享', 0, 0, 1, NULL, NOW(), NOW());
INSERT INTO nodes(`id`, `name`, `alias`, `desc`, `count`, `pid`, `state`, `deleted_at`, `created_at`, `updated_at`)
    VALUES (2, '提问', 'question', '问题分享', 0, 0, 1, NULL, NOW(), NOW());
INSERT INTO nodes(`id`, `name`, `alias`, `desc`, `count`, `pid`, `state`, `deleted_at`, `created_at`, `updated_at`)
    VALUES (3, '反馈', 'feedback', '问题反馈', 0, 0, 1, NULL, NOW(), NOW());
